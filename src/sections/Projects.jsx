...
const projects = [
  {
    ...
    description:
      "A modern automotive website built for the BYD brand, focusing on clean design, performance, and easy content management. Developed using Nuxt and connected to a headless CMS (Strapi), enabling flexible content updates and fast deployment via Vercel.",
    image: "/projects/byd-web-thumbnail.jpg",
    tags: ["Nuxt ", "Strapi", "Vercel"],
    link: "https://bydmiskolc.hu/",
    // github: "#",
  },
  {
    title: "Automotive Corporate Website",
    description:
      "A corporate automotive website built and maintained using Symfony, focusing on stability, functionality, and ongoing improvements. Involved in both frontend and backend development, implementing new features, fixing issues, and ensuring smooth operation of the platform.",
    image: "/projects/dunaauto_thumbnail.jpg",
    tags: ["Symfony ", "JavaScript ", "MySQL"],
